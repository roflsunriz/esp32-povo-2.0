...
constexpr const char* nextPoll = "次回あと%llu分%llu秒";
constexpr const char* fetchingText = "取得中";
...
constexpr const char* sleepCombined = "消灯: %u時間%u分";
constexpr const char* sleepAlwaysOn = "消灯: 常にオン";
constexpr const char* sleepMinutesLabel = "分 0-59: %u分";
constexpr const char* sleepHoursLabel = "時間 0-24: %u時間";
constexpr const char* sleepPollLabel = "取得期間 60-600秒: %u秒";
constexpr const char* sleepAlwaysNote = "0分0時間は常にオン";
